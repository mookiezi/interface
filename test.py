...
parser.add_argument("-fl", "--frozen_lora",
                    help="Model path or Hugging Face repo ID of the base LoRa adatper to load and freeze")
parser.add_argument("-c", "--checkpoint",
                    help="Model path or Hugging Face repo ID of the LorA adapter to load")
parser.add_argument("-chs", "--checkpoint_subfolder",
...
parser.add_argument("-asc", "--assistant-system-combo", action="store_true", default=False,
                    help="Include both system and assistant system prompts (default: False)")
parser.add_argument("-as", "--assistant-system", action="store_true", default=False,
...
if GGUF:
    ...
    if USE_BASE_MODEL_ONLY:
        ...
        # Load base model first for LoRA stack
        if QUANTIZATION:
